...
Nella meccanica classica questo fenomeno è descritto dall'evoluzione delle coordinate canoniche nello spazio delle fasi; in meccanica quantistica, esso è descritto da un opportuno \emph{operatore di evoluzione temporale}, sia esso $\op U(t)$, per il quale $\ket{\psi(t)}=\op U(t)\ket{\psi(0)}$.
...
\end{equation}
Notiamo che con questa forma l'operatore $\op U(t)$ rispetta, in modo ovvio, le proprietà che ci aspettiamo possieda:
\begin{itemize}
